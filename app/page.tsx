...
export default function Page() {
  ...
  return (
    <main className="relative flex min-h-screen w-full flex-col gap-12 px-6 pb-24 pt-20 sm:px-10 lg:px-16 xl:gap-14">
      ...
      <section className="grid items-stretch gap-10 xl:gap-12 lg:grid-cols-[minmax(320px,420px)_minmax(0,1fr)]">
        <div className="mx-auto h-full w-full max-w-xl lg:mx-0">
          <div className="glow-card flex h-full flex-col gap-6 p-6 sm:p-8">
            <div
        ...
        <div className="relative mx-auto h-full w-full max-w-5xl overflow-hidden rounded-3xl border border-[#00bbff]/25 bg-gradient-to-br from-[#030028]/80 via-[#05003a]/70 to-[#030028]/80 p-6 sm:p-10 lg:mx-0 lg:max-w-none">
